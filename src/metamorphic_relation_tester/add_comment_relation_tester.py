'''
    Drives the test for the add comment relation
'''
...
class AddCommentRelationTester(MetamorphicRelationTester):
    ...
    def __test_relation_c(self, number_of_test_cases):
        ...
        for i in range(number_of_test_cases):
            ...
            try:
                ...
                base_program_string = base_program_string["program"]
                ...
                with open('././datafiles/random_c_programs.json', 'r', encoding="utf-8") as file:
                    data = json.load(file)
    ...
    def __test_relation_py(self, number_of_test_cases):
        ...
        for i in range(number_of_test_cases):
            ...
            try:
                ...
                print("Test case " + str(i + self.number_of_test_cases - number_of_test_cases) + 
                      " done.")

            except:
                # Step 1b: Randomly pick from a safe pool of Python programs
                with open('././datafiles/random_py_programs.json', encoding="utf-8") as file:
                    random_py_programs = json.load(file)

                random_index = random.randrange(len(random_py_programs))

                with open('././datafiles/random_py_datatypes.json', encoding="utf-8") as file:
    ...
    def __process_relation_c(self, base_program_string):
        ...
        # Step 3a: Put the base and modified programs into parser endpoint to
