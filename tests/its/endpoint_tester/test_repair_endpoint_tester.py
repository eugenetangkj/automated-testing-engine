...
PROGRAM_SUCCESSFUL = "def add1(a, b): return a + b"
PARSED_PROGRAM_SUCCESSFUL = '{"importStatements": [], "fncs": {"add1": {"name": "add1", "rettype": "*", "initloc": 1, "endloc": 0, "params": [{"val0": "a", "val1": "*", "valueArray": ["a", "*"], "valueList": ["a", "*"]}, {"val0": "b", "val1": "*", "valueArray": ["b", "*"], "valueList": ["b", "*"]}], "locexprs": {"1": []}, "loctrans": {"1": {}}, "locdescs": {"1": "around the beginning of function \'add\'"}, "types": {}}}}'

PROGRAM_UNSUCCESSFUL = "def add2(a, b): return b"
PARSED_PROGRAM_UNSUCCESSFUL = '{"importStatements": [], "fncs": {"add2": {"name": "add2", "rettype": "*", "initloc": 1, "endloc": 0, "params": [{"val0": "a", "val1": "*", "valueArray": ["a", "*"], "valueList": ["a", "*"]}, {"val0": "b", "val1": "*", "valueArray": ["b", "*"], "valueList": ["b", "*"]}], "locexprs": {"1": []}, "loctrans": {"1": {}}, "locdescs": {"1": "around the beginning of function \'add2\'"}, "types": {}}}}'
...
class MockItsApiConnection(ItsApiConnection):
    def call_repair_endpoint(self, request_payload: dict):
        ...
        unsuccessful = json.dumps(PARSED_PROGRAM_UNSUCCESSFUL)
...
def test_repair_equivalent_tester():
    ...
    test_result = repair_tester.run_test(
        {"name": "add1", "argument_types": ["int"], "return_type": "int"},
        BASE_PROGRAM,
        PROGRAM_UNSUCCESSFUL,
        PARSED_BASE_PROGRAM,
        PARSED_PROGRAM_UNSUCCESSFUL,
        [],
    )
