import json
from its_test_engine.enums import Language, TypeOfMetamorphicRelation
...
def test_equivalent_error_localizer_endpoint_tester():
...
def test_variant_error_localizer_endpoint_tester():
    its_api_connection = MockItsApiConnection(Language.PYTHON)

    error_localizer_tester = ErrorLocalizerEndpointTester(
        its_api_connection, TypeOfMetamorphicRelation.VARIANT
    )
