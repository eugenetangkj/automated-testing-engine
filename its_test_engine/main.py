...
from its_test_engine.python.modifier import VariableRenamer, BinOpModifier, ForRangeToWhileLoopModifier, UnravelTernaryModifier, DeMorganModifier, IdempotentModifier, IdentityModifier
...
def run_open_ai_programs():
    ...
    input_generator = RandomInputGenerator()
    transformers = [IdentityModifier(), DeMorganModifier()]
