"""
    Tester for the feedback error endpoint
"""
...
class FeedbackErrorEndpointTester(EndpointTester):
    """
    This is a concrete class that is responsible for testing the feedback error endpoint
    ...
    def __init__(self, api_output_comparator: ApiOutputComparator,
        ...
        """
        Initialisation method for a FeedbackErrorEndpointTester instance
        """
    ...
    def test_endpoint(self, base_program_string, modified_program_string, base_program_intermediate,
        ...
        Returns:
           ...
           of testing the test case with the feedback error endpoint if an error
        ...
        try:
            ...
            did_feedback_error_pass = self.check_status_of_result(output_feedback_error)
            if not did_feedback_error_pass:
                ...
                test_result = TestResult(
                    ...
                    problematic_output=json.dumps(output_feedback_error, indent=4)
                )
                return test_result
            else:
                # Test case pass
    ...
    def check_status_of_result(self, api_result: dict):
        ...
        did_feedback_error_pass = self.api_output_comparator.check_feedback_error_output(
            feedback_error_output= api_result,
            type_of_metamorphic_relation= self.type_of_metamorphic_relation
        )
        return did_feedback_error_pass
